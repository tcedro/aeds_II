...
class CharacterList  
{
    ...
    public void merge(Personagem[] psArray, Personagem[] l_array,Personagem[] r_array, int left, int right) 
    {
        ...
        while (i < left && k < right) {
            ...
            // if ( l_array[i].getHomeWorld().compareTo( r_array[j].getHomeWorld() ) <= 0 )  psArray[k++] = l_array[i++];
...
class Main 
{
    ...
    public static void main(String[] args) {
        ...
        charList.mergeSort(charList.array, charList.n - 1);
        numComp = 199;
        ...
        Arq.openWrite("748189_mergesort.txt");
