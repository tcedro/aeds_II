/**
 * @author Thiago Cedro Silva de Souza
 * @brief class Stack to tp aedsII
 * @version v0.1
 */
...
{
    public Personagem stack[];
    public int lenght; 

    CharacterStack (int size){
        this.lenght = 0;
        this.stack = new Personagem [size];
    }

    //---------------------------- push -------------------------------//

    public void push(Personagem element){
        if ( stack.length > lenght ){
            this.stack[this.lenght++] = element;
        }
    }
...
class Main 
{
    ...
    public static void main(String[] args) {
        ...
        CharacterStack charStack = new CharacterStack(100);
        ...
        for (int i = 0; i < numOp; i++) {
            ...
            if( func.compareTo("I") == 0) {
                ...
                // Integer pos = Integer.parseInt(tmp.substring(2, tmp.indexOf(" ", 3)));
            ...
            //----------------------------------- Pop ----------------------------------//
                ...
                MyIO.println( "(R) " + charStack.pop().getNome() );
            }
        }

        // PRINT LIST
        MyIO.print(charStack.toString());
    }
}