...
int numSwapsBubbleSort    = 0;
int numCompsBubbleSort = 0;
...
//--------------------------------------------------------------------------//
    ...
    bubbleSort(listaPers);
    
    printList(listaPers);

    FILE *f = fopen("748189_bolha.txt", "wt");
    fprintf(f, "749190\t %ld\t %d", (clock() - startTime), numCompsBubbleSort);
